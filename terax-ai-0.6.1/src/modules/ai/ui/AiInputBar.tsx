...
import { Popover, PopoverAnchor } from "@/modules/core/ui/popover";
...
import { useComposer, type FileAttachment } from "../ui/composer";
import { SLASH_COMMANDS } from "../engine/slashCommands";
          ...
          <PopoverAnchor asChild>
            <div className="flex items-start gap-2">
              <textarea
                ...
                placeholder="Ask Cipher anything   -   # for snippets and commands"
                rows={1}
                disabled={c.isBusy}
                className={cn(
