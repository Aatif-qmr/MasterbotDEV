import {
  ...
  ContextTrigger,
} from "@/modules/ai/ui/elements/context";
...
import type { SessionMeta } from "../engine/sessions";
...
function EmptyState({ onPick }: { onPick: (text: string) => void }) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-8 py-10 text-center">
      <img src="/logo.png" alt="Cipher" className="size-14 opacity-90" />
      <div className="space-y-1.5">
        <p className="text-[14px] font-semibold tracking-tight">
          Ask Cipher anything
        </p>
        <p className="max-w-[18rem] text-[11.5px] leading-relaxed text-muted-foreground">
          Cipher sees the active terminal — cwd, recent commands, and output.
        </p>
      </div>
